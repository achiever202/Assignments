...
int main(void)
{
	...
	while (TRUE) {
		 ...
		 * This case is for changing the number of tickets in the process.
		 * This is called from the schedule.c in pm server.
		 * It then calls the routine for changing ticket in schedule.c in the sched server.
		 */
		case 3900:
